...
//shortest way just for the get request right away
    ...
    /*
    HOMEWORK: ROLE BASE ACCESS CONTROL RBAC
ADMIN SHOULD BE ABLE TO DO CRUD
EDITOR SHOULD BE ABLE TO DO CRUD ( WE KNOW EDITOR CAN'T DELETE)
USER SHOULD ONLY BE ABLE TO READ DATA
CAN GUEST EVEN READ DATA? 401?
